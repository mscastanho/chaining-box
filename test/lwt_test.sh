...
function create_infra {
    ...
    bpftool map update pinned /sys/fs/bpf/tc/globals/nsh_data key hex 0a 01 00 01 0a 01 00 02 03 e8 07 d0 11 value hex 00 02 02 03 00 00 01 ff any
}
...
$NSCMD0 python send_packets.py $VETH0 no-nsh
